            ...
            <div class="container col-11">
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <input type="text" name="txtNombreUsuario" id="txtNombreUsuario" class="form-control" placeholder="Nombre Usuario" required="true">
                    </div>
                    <div class="col-6">
                        <label for="txtTrabajador">Trabajador Asociado</label>
                        <select class="form-control" name="txtTrabajador" id="txtTrabajador" required="true">
                            <c:forEach items="${trabajadores}" var="tra">
                                <option value="${tra.idTrabajador}">${tra.nombreTrabajador} ${tra.apellidoTrabajador}</option>
                            </c:forEach>
                        </select>  
                    </div>
                    <div class="col-6">
                        <label for="txtRol">Rol Asociado</label>
                        <select class="form-control" name="txtRol" id="txtRol" required="true">
                ...
                <div class="form-group">
                    <center>
                        <button type="submit" Style="background-color: #007bff; font-weight: bold;" class="btn btn-primary btn-block">Ingresar Nuevo Usuario</button>
                    </center>
                </div>
            </div>
        </form>
